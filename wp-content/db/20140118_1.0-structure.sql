...
CREATE TABLE IF NOT EXISTS `illinois_appraisal`.`wp_comments` (
  ...
  `comment_date_gmt` DATETIME NOT NULL DEFAULT '2000-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `illinois_appraisal`.`wp_links` (
  ...
  `link_updated` DATETIME NOT NULL DEFAULT '2000-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `illinois_appraisal`.`wp_posts` (
  ...
  `post_modified_gmt` DATETIME NOT NULL DEFAULT '2000-01-01 00:00:00',
